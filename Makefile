...
BUILD		:=	build
SOURCES		:=	source source/textures source/textures/inv_blocks source/block
DATA		:=	data
INCLUDES	:=
...
CPPFILES	:=	Main.cpp $(filter-out Main.cpp, $(foreach dir,$(SOURCES),$(notdir $(wildcard $(dir)/*.cpp))))
